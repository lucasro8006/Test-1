"""
Script para testar o agente com mais operações
"""
...
END_DATE = '2023-06-01'
COMMISSION = 0.0005  # Comissão menor para incentivar operações
SLIPPAGE = 0.0002  # Slippage menor
REWARD_TYPE = 'sharpe'  # Sharpe ratio tende a incentivar mais operações
TIMESTEPS = 50000  # Muito mais passos para garantir operações
...
model_params = {
    'policy': 'MlpPolicy',
    'learning_rate': 0.0001,  # Taxa de aprendizado menor para convergência mais estável
    'n_steps': 256,  # Passos maiores para capturar mais contexto
    'batch_size': 128,  # Batch maior para melhor generalização
    'gamma': 0.99,
    'ent_coef': 0.05,  # Mais exploração
    'policy_kwargs': {'net_arch': [256, 128, 64]},  # Rede neural maior
